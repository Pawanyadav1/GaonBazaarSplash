...
public class API {
    ...
    public static String show_cart=BASEURL+"show_cart";
    ...
    public static String privacy_policy=BASEURL+"privacy_policy";
    public static String add_feedback=BASEURL+"add_feedback";
